      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          <div class="card-header bg-secondary text-white">
            ...
            <center><i class="fas fa-table"> Proses Check Out</i>
          </div>
          </center>
            ...
            <div class="form-body">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="col-md-9">
                        <input type="text" class="form-control" name="kode_reservasi" value="<?php echo $kode_reservasi; ?>" disabled>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label class="control-label col-md-6">Harga Kamar/malam</label>
                      <div class="col-md-9">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="col-md-9">
                        <input type="number" class="form-control" name="uang_bayar" id="uang_bayar" value="<?= $total_bayar ?>" min="<?= $total_bayar ?>">
